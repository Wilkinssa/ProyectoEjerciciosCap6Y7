...
{
    public partial class Ejercicio5Cap6 : Form
    {
        public Ejercicio5Cap6()
        {
            InitializeComponent();
        }
        ...
        private void Aceptar_Click(object sender, EventArgs e)
        {
            ...
            ImprimirCalificaciones(calif, salones);
            EscribirMaxMin(Mayor, Menor);
        }
        void ImprimirCalificaciones(float[][] calif, float salones)
        {
            for (int i = 0; i < salones; i++)
            {
                ...
                for (int j = 0; j < calif[i].GetLength(0); j++)
                {
                    ListCalificaciones.Items.Add("Salon " + (i + 1) + " Estudiante " + (j + 1) + ": Calificacion: " + calif[i][j]);
                }
            }
        }
        private void Nuevo_Click(object sender, EventArgs e)
        {
            ...
            ListCalificaciones.Items.Clear();
        }
